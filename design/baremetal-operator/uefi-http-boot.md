...
exactly like it happened with a standard ramdisk during PXE boot.
...
The new hardware driver will be available upgrading the version of Baremetal
Operator.
...
- To rely on Virtual Media boot is necessary to grant access to the
